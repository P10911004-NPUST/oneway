test_that("oneway_anova", {
    ...
    aov_1 <- oneway_anova(O_O_O, val ~ grp, var_equal = TRUE, rounding = 5, verbose = FALSE)
    ...
    aov_1 <- oneway_anova(O_O_X, val ~ grp, var_equal = TRUE, rounding = 5, verbose = FALSE)
    ...
    # Welch's ANOVA
    aov_1 <- oneway_anova(O_X_X, val ~ grp, var_equal = FALSE, rounding = 5, verbose = FALSE)
